          ...
          <div className="text-primary-color">
            ...
            <div className="relative">
              <input
                type="text"
                value="20,000"
                className="w-full ps-[42px] px-[21px] py-[19px] text-[16px] font-[600] leading-[27px] border border-[#0000001F] bg-white rounded-[14px]"
                readOnly
              />
          ...
          <div className="text-primary-color">
            ...
            <div className="relative">
              <input
                type="text"
                value="20%"
                className="w-full px-[21px] py-[19px] text-[16px] font-[600] leading-[27px] text-primary-color text-opacity-[0.6] bg-[#F5F5F5] rounded-[14px]"
                readOnly
              />
