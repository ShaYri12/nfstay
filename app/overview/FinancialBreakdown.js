        ...
        <div className="bg-[#F7F6FF] rounded-[14px] md:px-[25px] md:py-[25px] py-[20px] px-[12px] w-full md:w-1/2">
          ...
          <ul className="text-primary-color flex flex-col gap-[14px] pt-[20px]">
            <li className="flex justify-between gap-1">
              <span className="text-[13px] font-[500] leading-[18.9px] opacity-[0.5]">
                Property Listing Price
              </span>
              <span className="text-[13px] font-[600] leading-[18.9px]">
                USD 728,000
              </span>
            </li>
            <li className="flex justify-between gap-1">
            ...
            <li className="flex justify-between text-[#954AFC] font-[700] text-[15px] leading-[22.68px] gap-1">
