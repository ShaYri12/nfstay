  ...
  return (
    ...
    `,
      ...
      >
        ...
        <div className="h-[270px] py-[27px]">Chart</div>
        <div className="flex flex-col gap-[10px] pb-[33px] sm:px-[25px] px-[12px]">
          ...
          <div className="flex gap-[5px] justify-between">
            <div className="flex items-center">
              <span className="flex border-[4px] border-primary-color rounded-full w-[20px] h-[20px]"></span>
              <p className="ps-[16px] sm:text-[18px] text-[16px] font-[500] text-primary-color leading-[27px]">
                STAY
              </p>
            </div>
            <p className="text-primary-color sm:text-[18px] text-[16px] font-[700] leading-[25.2px]">
              25%
            </p>
          </div>
        </div>
